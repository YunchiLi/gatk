...
//        genomeLocParser = new GenomeLocParser(sequenceDictionary);
        ...
        Pair<List<CopyNumberPosteriorLocatableRecord>, IntegerCopyNumberStateCollection> firstCopyNumberPosteriorFileInfo =
        ...
        final GCNVPostProcessor gcnvPostProcessor = new GCNVPostProcessor(outputWriter, copyNumberStateCollection, sampleDirectoryName);
        ...
        for(String chunkRootDirectory: chunkDirectoryList) {
            ...
            Pair<List<CopyNumberPosteriorLocatableRecord>, IntegerCopyNumberStateCollection> chunkedCopyNumberPosteriorFileInfo =
     ...
     */
    private Pair<List<CopyNumberPosteriorLocatableRecord>, IntegerCopyNumberStateCollection> readChunkedPosteriorFileFromDirectory(final String chunkRootDirectory) {
        ...
        // Use SimpleIntervalCollection instead
...
//        final List<SimpleInterval> chunkIntervalList = IntervalUtils.convertGenomeLocsToSimpleIntervals(chunkGenomeLocList);
        ...
        //TODO file an issue: the directory name does not correspond to sample name of the sample being processed
//        if (!sampleDirectoryName.equals(chunkedCopyNumberPosteriorCollection.getMetadata().getSampleName())) {
...
//        }
        ...
        return new ImmutablePair<>(copyNumberPosteriorLocatableRecordList, chunkCopyNumberStateCollection);
    }
