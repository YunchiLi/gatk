 ...
 * HDF5 or TSV count files generated by {@link CollectFragmentCounts}.
 *
 * <h3>Introduction</h3>
 *
 ...
 *         <tr>
 *             <td>CONTIG_NAME</td> <td>PLOIDY_PRIOR_0</td> <td>PLOIDY_PRIOR_1</td> <td>PLOIDY_PRIOR_2</td> <td>PLOIDY_PRIOR_3</td>
 *         </tr>
 *         <tr>
 ...
 *     unexplained variance (set by <code>--global-psi-scale &lt;value&gt;</code> and <code>--sample-psi-scale &lt;value&gt;</code>,
 *     respectively). It is crucial to note that these hyperparameters are <em>not</em> universal and must be
 *     tuned for each sequencing protocol and properly set at runtime.</p></dd>
 *
 ...
 *
 *     <dt>Coverage-based germlikne karyotyping:</dt>
